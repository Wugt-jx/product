 ...
 */
public class GetAwardInfoExService extends BaseService {
    public GetAwardInfoExService() {
        super(ApiConstant.HTTP_GETAWARDINFOEX_URL);
    }

    public GetAwardInfoResponse request(String issue, int currentPage, int showCount){
        this.isNull();
        ...
        return JSONObject.parseObject(sendPost(params), GetAwardInfoResponse.class);
    }
}
