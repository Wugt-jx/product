 ...
 */
public class GetLotteryListByOrderNoServiceTest extends TestCase {
    public void testRequest() throws Exception {
        ...
        GetLotteryListByOrderNoService service=new GetLotteryListByOrderNoService();
        GetLotteryListResponse response=service.request(1,1,"dvsdbas");
